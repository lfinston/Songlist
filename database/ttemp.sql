replace into Songs (title, source) values ("Aba Daba Honeymoon", "{\\bf 100 Years of Popular Music, 1900s}");
...
replace into Songs (title, source) values ("", "");
Alice Blue Gown, "{\\bf 100 Years of Popular Music, 1900s)

replace into Songs (title, source) values ("", "");
Alice Blue Gown, "{\\bf 100 Years of Popular Music, 1920s, Volume 1)
...
Come, Josephine In My Flying Machine
 (Up She Goes!), "{\\bf 100 Years of Popular Music, 1900s)}
