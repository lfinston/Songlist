...
update Songs set eps_filenames = "chicago1.eps;chicago2.eps;" where title = "Chicago (That Toddling Town)";
...
update Songs set eps_filenames = "heart1.eps;heart2.eps;" where title = "Heart (You've Gotta Have Heart)";
...
update Songs set eps_filenames = "golddig1.eps;golddig2.eps;" where title = "Gold Diggers' Song, The (We're in the Money)";
...
update Songs set eps_filenames = "jealsy01.eps;jealsy02.eps;jealsy03.eps;jealsy04.eps;jealsy05.eps;" where title = "Jalousie ``Tango Tzigane'' (Jealousy)";
...
update Songs set eps_filenames = "stdsfiav1.eps;stdsfiav2.eps;" where title like("Se Todos Fossem%");

update Songs set eps_filenames = "shfnttw1.eps;shfnttw2.eps;" where title = "She's Funny That Way";

update Songs set eps_filenames = "shnhrvm1.eps;shnhrvm2.eps;" where title = "Shine On Harvest Moon";

update Songs set eps_filenames = "smblvs01.eps;smblvs02.eps;" where title = "Somebody Loves Me";

update Songs set eps_filenames = "snqmdjbs1.eps;snqmdjbs2.eps;" where title like("%que me dejabas%");

update Songs set eps_filenames = "smenevng1.eps;smenevng2.eps;" where title = "Some Enchanted Evening";

update Songs set eps_filenames = "whatkind.eps;" where title = "What Kind of Fool Am I?";
...
update Songs set eps_filenames = "swngstr1.eps;swngstr2.eps;" where title = "Swinging On A Star";

update Songs set eps_filenames = "teatwo01.eps;teatwo02.eps;teatwo03.eps;teatwo04.eps;teatwo05.eps;" where title = "Tea for Two";

update Songs set eps_filenames = "temptat1.eps;temptat2.eps;" where title = "Temptation";

update Songs set eps_filenames = "thycnt01.eps;thycnt02.eps;" where title = "They Can't Take That Away From Me";

update Songs set eps_filenames = "thngswd1.eps;thngswd2.eps;" where title = "Things We Did Last Summer, The";

update Songs set eps_filenames = "thouswell01.eps;thouswell02.eps;" where title = "Thou Swell";

update Songs set eps_filenames = "tgrdnlc1.eps;tgrdnlc2.eps;" where title = "Ti Guarder{\\`e}ro Nel Cuore (More)";

update Songs set eps_filenames = "tictic01.eps;tictic02.eps;tictic03.eps;tictic04.eps;tictic05.eps;" where title = "Tico Tico no Fuba";

update Songs set eps_filenames = "tomyoblg1.eps;tomyoblg2.eps;" where title = "Tomo y Obligo";

update Songs set eps_filenames = "tphtwtt1.eps;tphtwtt2.eps;" where title = "Top Hat, White Tie and Tails";

update Songs set eps_filenames = "twosleep.eps;" where title = "Two Sleepy People";

update Songs set eps_filenames = "vrytht01.eps;vrytht02.eps;" where title = "Very Thought of You, The";

update Songs set eps_filenames = "volvr1.eps;volvr2.eps;" where title = "Volver";

update Songs set eps_filenames = "wave01.eps;wave02.eps;" where title = "Wave";

update Songs set eps_filenames = "weveonly.eps;" where title = "We've Only Just Begun";

update Songs set eps_filenames = "whtwndf1.eps;whtwndf2.eps;" where title = "What a Wonderful World";

update Songs set eps_filenames = "whenlov1.eps;whenlov2.eps;" where title = "When I Fall in Love";

update Songs set eps_filenames = "whensml1.eps;whensml2.eps;whensml3.eps;" where title = "When You're Smiling";

update Songs set eps_filenames = "onlvam01.eps;onlvam02.eps;" where title = "Once in Love with Amy";

update Songs set eps_filenames = "whwsibrn1.eps;whwsibrn2.eps;" where title = "Why Was I Born?";

update Songs set eps_filenames = "wlngnoch1.eps;wlngnoch2.eps;" where title = "Wie lange noch?";

update Songs set eps_filenames = "ychtclub1.eps;ychtclub2.eps;" where title = "Yacht Club Swing";

update Songs set eps_filenames = "youmdm01.eps;youmdm02.eps;youmdm03.eps;youmdm04.eps;" where title = "You Made Me Love You";

update Songs set eps_filenames = "ytkadvn1.eps;ytkadvn2.eps;ytkadvn3.eps;" where title = "You Took Advantage of Me";

update Songs set eps_filenames = "yrnbdytl1.eps;yrnbdytl2.eps;" where title = "You're Nobody 'Til Somebody Loves You";
