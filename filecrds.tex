...
\def\A#1#2#3#4{\leftline{\hskip#1\hskip2em {\mediumbx #2}}
\vskip12pt
\leftline{\hskip#1\hskip2em #3}
\vskip12pt
\leftline{\hskip#1\hskip2em #4}}
...
\A{0pt}{Call Me}{Words and Music:  Tony Hatch}{Copyright {\copyright} 1965}
\vss}
\vbox to 0pt{\vskip.125cm
\vskip.25\vsize
\A{.5\hsize}{Camelot}{Words:  Alan Jay Lerner.  Music:  Frederick Loewe}{Copyright {\copyright} 1960}
\vss}
\eject
...
\vbox to 0pt{\vskip.125cm
\A{0pt}{Capri Fischer}{Words:  Ralph Maria Siegel.  Music:  Gerhard Winkler}{Copyright {\copyright} 1943}
\vss}
